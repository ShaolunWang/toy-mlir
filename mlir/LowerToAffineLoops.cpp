...
// LoopIterationFn is a function that takes an OpBuilder and two sets of
// operands (the inputs to the operation and the loop induction variables) and
// returns a Value.
...
struct FuncOpLowering : public OpConversionPattern<toy::FuncOp> {
  ...
  LogicalResult
  matchAndRewrite(toy::FuncOp op, OpAdaptor adapter,
                  ConversionPatternRewriter &rewriter) const final {
